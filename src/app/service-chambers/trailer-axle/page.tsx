...
export const metadata: Metadata = {
  title: 'Trailer Axle Service Chambers | BRC Manufacturer',
  description: 'Reliable service chambers for commercial trailer axle configurations.',
};
...
export default async function SubCategoryPage(props: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        badge="Trailer Axle Service"
        title="Trailer Axle Service Chambers"
        description="Designed specifically for the harsh environment of commercial trailers, these service chambers provide reliable, everyday stopping power for flatbeds, dry vans, and refrigerated trailers."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Service Chambers', href: '/service-chambers' },
          { label: 'Trailer Axle Service Chambers' }
        ]}
      />
