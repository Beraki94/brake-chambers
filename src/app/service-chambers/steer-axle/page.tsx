...
export default async function SubCategoryPage(props: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        badge="Steer Axle Service"
        title="Steer Axle Service Chambers"
        description="Steer axle braking requires precise modulation and rapid response. Our Steer Axle Service Chambers (typically Type 20 and Type 24) are engineered for smooth, predictable brake application to maintain vehicle control during critical stops."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Service Chambers', href: '/service-chambers' },
          { label: 'Steer Axle Service Chambers' }
        ]}
      />
      ...
      <div className="mt-16 mb-12">
        <div className="max-w-3xl mx-auto">
          ...
          <GlobalFAQAccordion faqs={[
            {
              q: 'What is the most common steer axle chamber size?',
              a: 'Type 20 and Type 24 service chambers are the most common sizes utilized on heavy-duty truck steer axles.'
            }
          ]} />
        </div>
      </div>
