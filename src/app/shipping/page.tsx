      ...
      <section className="container mx-auto px-4 lg:px-8 max-w-4xl -mt-20 relative z-20">
        <div className="bg-white rounded-2xl shadow-xl border border-navy-50 p-8 md:p-12 space-y-8 text-navy-600">
          ...
          <div>
            ...
            <p>We support standard Incoterms for international trade, primarily <strong>EXW</strong>, <strong>FOB (Shanghai / Ningbo)</strong>, and <strong>CIF</strong> to your destination port. If you do not have a dedicated logistics partner, our expert export department can arrange reliable freight forwarders to handle customs clearance and delivery to your warehouse door. <Link href="/contact" className="text-primary-600 font-bold hover:underline">Contact us to arrange shipping.</Link></p>
          </div>
          <div className="h-px w-full bg-slate-100"></div>
          <div>
            <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
          ...
          <div>
            <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
