  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        ...
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Air Disc Actuators', href: '/air-disc-brake-actuators' },
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-20">
        ...
        <div className="w-full lg:w-64 flex-shrink-0 flex flex-col gap-4">
           <FacetedSidebar baseCategory="air-disc-brake-actuators" />
          ...
          {products.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-4">
              {products.map(product => (
                <ProductListCard key={product.slug} product={product} categoryPath="air-disc-brake-actuators" />
              ))}
            </div>
          ) : (
