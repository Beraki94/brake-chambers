...
export const metadata: Metadata = {
  ...
  description: 'Complete repair and piggyback kits for fast and safe field maintenance.',
};
...
export default async function SubCategoryPage(props: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  let products = BRAKE_CHAMBERS.filter(c => c.name.toLowerCase().includes('piggyback'));
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        ...
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Chamber Parts Kits', href: '/parts-and-kits' },
          ...
          {products.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-4">
              {products.map(product => (
                <ProductListCard key={product.slug} product={product} categoryPath="parts-and-kits" />
              ))}
            </div>
          ) : (
      ...
      <div className="mt-16 mb-8 border-t border-slate-200 pt-16">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-navy-900">Why Choose BRC for Brake Chamber Repair Kits?</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">Cost-Effective</h3>
            <p className="text-slate-600 leading-relaxed">Repairing rather than replacing the entire unit saves significant maintenance costs.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">Pre-Caged Safety</h3>
            <p className="text-slate-600 leading-relaxed">Power springs are pre-caged at the factory to ensure safe installation by technicians.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">Complete Hardware</h3>
            <p className="text-slate-600 leading-relaxed">Kits include fresh clamp bands, diaphragms, and bolts for a complete seal.</p>
          </div>
