  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        ...
        description="The diaphragm is the heart of the brake chamber. Our Replacement Rubber Diaphragms are molded from premium neoprene and reinforced with high-strength nylon fabric to resist tearing and fatigue even at extreme temperatures."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Chamber Parts Kits', href: '/parts-and-kits' },
          { label: 'Replacement Rubber Diaphragms' }
        ]}
      />
