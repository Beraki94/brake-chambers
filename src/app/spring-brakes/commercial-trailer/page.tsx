...
export const metadata: Metadata = {
  title: 'Commercial Trailer Spring Brakes | BRC Manufacturer',
  description: 'Durable spring brake chambers optimized for semi-trailers and commercial hauling.',
};
...
export default async function SubCategoryPage(props: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        badge="Commercial Trailer Spring"
        title="Commercial Trailer Spring Brakes"
        description="Commercial trailers face unique braking challenges, from varied load weights to extreme weather exposure. Our Trailer Spring Brakes are built to provide consistent, fade-resistant parking and emergency braking across all trailer axles."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Spring Brakes', href: '/spring-brakes' },
          { label: 'Commercial Trailer Spring Brakes' }
        ]}
      />
      ...
      <div className="mt-16 mb-8 border-t border-slate-200 pt-16">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-navy-900">Why Choose BRC for Commercial Trailer Spring Brakes?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">Weather-Sealed Design</h3>
            <p className="text-slate-600 leading-relaxed">Advanced crimping and sealing prevents moisture intrusion and inner corrosion.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">High-Strength Clevis</h3>
            <p className="text-slate-600 leading-relaxed">Available with welded or threaded clevis options to match any trailer slack adjuster.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-3">Fleet Ready</h3>
            <p className="text-slate-600 leading-relaxed">Available in bulk quantities for large trailer fleet maintenance programs.</p>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
              <h3 className="text-lg font-bold text-navy-900 mb-2">Do you offer bulk pricing for trailer fleets?</h3>
              <p className="text-slate-600">Yes, we specialize in direct-to-fleet bulk orders and pallet pricing. Please use the Request Wholesale Quote button for fleet pricing.</p>
            </div>
