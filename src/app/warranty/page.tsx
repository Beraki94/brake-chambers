      ...
      <section className="container mx-auto px-4 lg:px-8 max-w-4xl -mt-20 relative z-20">
        <div className="bg-white rounded-2xl shadow-xl border border-navy-50 p-8 md:p-12 space-y-8 text-navy-600">
          ...
          <div>
            ...
            <p>If a batch contains defective units, distributors must <Link href="/contact" className="text-primary-600 font-bold hover:underline">contact support</Link> to provide video and photographic evidence of the defect along with the batch serial number. We will issue replacements in your next container shipment or provide credit notes.</p>
          </div>
        </div>
      </section>
    </div>
