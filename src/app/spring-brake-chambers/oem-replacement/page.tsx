...
export const metadata: Metadata = {
  title: 'OEM Replacement Spring Brakes | BRC Manufacturer',
  description: 'Direct-fit OEM replacement spring brake chambers matching OEM specs and performance.',
};
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-clip">
      <PageHeader 
        ...
        description="Why pay premium dealership markups when you can source direct from the manufacturer? Our OEM Replacement Spring Brakes are built to the exact dimensional and performance specifications of the industry's leading brands."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Spring Brakes', href: '/spring-brake-chambers' },
          { label: 'OEM Replacement Spring Brakes' }
        ]}
      />
