        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-amber-600 transition-colors">8-Gauge Steel Housings</h3>
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              <div className="w-16 h-16 rounded-2xl bg-navy-50 border border-navy-100/50 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
                <Droplet className="w-8 h-8 text-navy-500" />
              </div>
              <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-navy-600 transition-colors">Advanced Neoprene Rubber</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-amber-600 transition-colors">Dual-Layer Corrosion Defense</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-navy-600 transition-colors">Machined Push-Rods</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-amber-600 transition-colors">Premium Aluminum Ingots</h3>
              <p className="text-slate-600 leading-relaxed">
