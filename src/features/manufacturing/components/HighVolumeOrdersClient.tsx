...
export default function HighVolumeOrdersClient() {
  ...
  const tiers = [
    {
      ...
      color: 'slate',
      features: ['Standard catalog products', 'LCL ocean freight support', 'Standard 45-day lead time', 'Email-based account support'],
    },
    {
      tier: 'Growth',
      ...
      color: 'amber',
      popular: true,
      features: ['Full catalog + custom specs', 'Optimized LCL/FCL shipping', '35-day priority lead time', 'Dedicated account manager'],
    },
    {
      tier: 'Enterprise',
      ...
      color: 'navy',
      features: ['Custom OEM engineering available', 'Full container (FCL) optimization', '30-day fast-track production', 'Quarterly business reviews'],
    },
    {
      tier: 'Strategic',
      range: '20,000+ units',
      ...
      color: 'emerald',
      features: ['Dedicated production line access', 'Multi-container programs', 'Inventory forecasting & JIT', 'Executive partnership program'],
    },
  ];
  ...
  const stats = [
    ...
    { value: '45', label: 'Day Standard Lead Time', icon: Clock },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center">
            <h2 className="text-3xl md:text-5xl font-black text-navy-900 mb-6 tracking-tight leading-tight">
              Factory-Direct <span className="text-amber-500">Pricing</span> at Scale
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1920px]">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-navy-900 tracking-tight">
              Volume <span className="text-amber-500">Discount</span> Structure
            </h2>
            <p className="text-slate-600 text-base md:text-lg font-light leading-relaxed max-w-2xl mx-auto mt-4">
              Transparent tiered pricing — the more you order, the better your margins.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1920px] relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight">
              The High-Volume <span className="text-amber-400">Advantage</span>
            </h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
          <h2 className="text-2xl md:text-4xl font-black text-navy-900 mb-4 tracking-tight">
            Request Your Volume Pricing
          </h2>
          <p className="text-slate-600 text-base md:text-lg font-light leading-relaxed mb-8 max-w-2xl mx-auto">
            Tell us your target volumes and product mix, and we'll provide a detailed quotation 
            with tiered pricing, container optimization analysis, and estimated lead times.
          </p>
