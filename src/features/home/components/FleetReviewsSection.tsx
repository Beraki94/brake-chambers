...
export default function FleetReviewsSection({ categoryName }: { categoryName: string }) {
  ...
  return (
    <section className="mt-8 sm:mt-12">
      <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-6 sm:p-8 md:p-10 lg:p-12 h-full w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
          {reviews.map((review) => (
            <div key={review.id} className="bg-slate-50 border border-slate-100 rounded-3xl p-6 sm:p-8 relative">
