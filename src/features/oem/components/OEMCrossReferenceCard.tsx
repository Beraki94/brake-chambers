...
export default function OEMCrossReferenceCard({ 
  ...
  return (
    <Link href={`/${categoryPath}/${product.slug}`} className="flex flex-col -slate-200 overflow-hidden hover: hover:-amber-400 group h-full">
<Card padding="md" hoverEffect="lift" glowColor="amber" className="h-full w-full">
