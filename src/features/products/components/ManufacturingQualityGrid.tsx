    ...
    <div className="mt-16 mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-4 md:gap-6">
        {qualityFeatures.map((feature, idx) => (
          <div key={idx} className="bg-white p-6 sm:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
