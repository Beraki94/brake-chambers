  ...
  const tests = [
    {
      ...
      icon: <Activity className="w-8 h-8 text-success-500" />
    },
    {
      ...
      icon: <ShieldAlert className="w-8 h-8 text-success-500" />
    },
    {
      ...
      icon: <Thermometer className="w-8 h-8 text-success-500" />
    },
    {
      ...
      icon: <Microscope className="w-8 h-8 text-success-500" />
    }
  ];
    ...
    <div className="bg-slate-50 min-h-screen pb-20">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-navy-900 mb-6 font-heading tracking-tight">
              Failure is <span className="text-success-500">Not an Option</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            {tests.map((test, idx) => (
              <div key={idx} className="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-shadow group">
                <div className="w-16 h-16 rounded-2xl bg-success-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  {test.icon}
                </div>
      ...
      <section className="bg-white py-16 border-t border-slate-200 text-center">
        <div className="container mx-auto px-4">
          ...
          <Link href="/company/research-and-innovations" className="inline-flex items-center text-primary-500 font-bold hover:text-primary-400 transition-colors uppercase tracking-widest text-lg">
