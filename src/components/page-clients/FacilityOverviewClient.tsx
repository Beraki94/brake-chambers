    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="relative h-[600px] rounded-[3rem] overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 bg-success-900/30 mix-blend-multiply"></div>
            </div>
            <div>
              <div className="inline-block px-4 py-1.5 mb-6 rounded-full bg-success-50 border border-success-100 text-success-600 text-[11px] font-bold uppercase tracking-widest">
                Global Headquarters
              </div>
              <h2 className="text-3xl md:text-5xl font-extrabold text-navy-900 mb-6 font-heading tracking-tight">
                Designed for <span className="text-success-500">Massive Scale</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                  <Box className="w-8 h-8 text-success-500 mb-4" />
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                  <Globe className="w-8 h-8 text-success-500 mb-4" />
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <Truck className="w-6 h-6 text-success-400" />
                  ...
                  <li className="flex items-center gap-3">
                    <Box className="w-6 h-6 text-success-400" />
      ...
      <section className="bg-slate-50 py-20 text-center border-t border-slate-200">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-extrabold text-navy-900 mb-6">See How We Ensure Perfection</h2>
