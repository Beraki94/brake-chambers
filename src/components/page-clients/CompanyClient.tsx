      ...
      cards: [
        {
          ...
          icon: <Factory className="w-6 h-6 md:w-8 md:h-8 text-blue-500" />,
        ...
        },
        {
          ...
          icon: <MapPin className="w-6 h-6 md:w-8 md:h-8 text-blue-500" />,
    ...
    <div className="min-h-screen bg-slate-50 font-sans overflow-x-clip">
      ...
      <section className="py-16 md:py-20 bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl md:text-5xl font-extrabold text-navy-900 mb-6 md:mb-8 font-heading tracking-tight leading-tight">
            Engineered to Outperform.<br/>Built to <span className="text-blue-600">Last.</span>
          </h2>
          <p className="text-slate-600 text-base md:text-xl leading-relaxed font-light mb-6 md:mb-8">
            When you partner with BRC Brake Chambers, you are cutting out the middlemen and dealing directly with the source. As a vertically integrated manufacturer of commercial air brake actuators, we control every variable of the production process—from raw metallurgy to final pneumatic leak testing. This means higher burst strength, longer operational lifespans, and absolute reliability for heavy-duty fleets worldwide.
          </p>
        </div>
      </section>
