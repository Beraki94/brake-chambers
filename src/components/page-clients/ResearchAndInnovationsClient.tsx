        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-navy-900 mb-6 font-heading tracking-tight">
              Engineering <span className="text-primary-500">Tomorrow's</span> Safety
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-200 shadow-sm text-center">
              <Lightbulb className="w-12 h-12 text-primary-500 mx-auto mb-6" />
            ...
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-200 shadow-sm text-center">
              <PenTool className="w-12 h-12 text-primary-500 mx-auto mb-6" />
            ...
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-200 shadow-sm text-center">
              <TrendingUp className="w-12 h-12 text-primary-500 mx-auto mb-6" />
