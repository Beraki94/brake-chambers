...
const HERO_SLIDES = [
  {
    ...
    cta1: { text: "Explore Products", link: "/spring-brakes" },
    cta2: { text: "Cross-Reference Tool", link: "/oem-cross-reference" },
  ...
  },
  {
    ...
    cta1: { text: "View Disc Brakes", link: "/contact" },
    cta2: { text: "Read Whitepaper", link: "/about#manufacturing" },
  ...
  },
  {
    ...
    cta2: { text: "View Shipping", link: "/shipping" },
  ...
  return (
    <div className="font-sans bg-[#F8FAFC]">
      ...
      <section className="relative min-h-[85vh] flex items-center bg-navy-950 overflow-hidden">
        ...
        {/* Content Container */}
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-30 py-20">
      ...
      <div className="bg-navy-900 border-y border-amber-500/30">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl py-4 flex flex-wrap justify-center sm:justify-between items-center gap-4 text-xs sm:text-sm font-bold text-navy-100 uppercase tracking-widest">
      ...
      <section className="py-20 bg-gradient-to-b from-white to-slate-50 border-b border-navy-50">
      ...
      <section className="py-20 bg-navy-950 relative overflow-hidden border-b border-navy-800">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10 text-center">
          ...
          <Link href="/oem-cross-reference" className="inline-flex items-center text-navy-950 bg-white font-extrabold px-8 py-3.5 rounded-xl hover:bg-amber-400 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(245,158,11,0.3)] text-[12px] uppercase tracking-widest transform hover:-translate-y-0.5">
            Launch Cross-Reference Tool <ArrowRight className="w-4 h-4 ml-2" />
          </Link>
        </div>
      </section>

      {/* 3. Comprehensive Product Architecture */}
      <section className="py-24 bg-gradient-to-b from-slate-50 to-slate-100 relative overflow-hidden">
      ...
      <section className="relative overflow-hidden bg-navy-950 h-[550px] flex items-center border-t border-navy-800 group">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
          <div className="max-w-2xl bg-navy-950/80 backdrop-blur-xl p-10 rounded-3xl border border-navy-800 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] transform transition-transform hover:-translate-y-1">
            ...
            <Link href="/about#manufacturing" className="inline-flex items-center text-navy-950 bg-white font-extrabold px-6 py-3.5 rounded-xl hover:bg-amber-400 transition-all duration-300 shadow-xl text-[12px] uppercase tracking-widest transform hover:-translate-y-0.5">
              Read Engineering Whitepaper <ArrowRight className="w-4 h-4 ml-2" />
            </Link>
          </div>
        </div>
      </section>
