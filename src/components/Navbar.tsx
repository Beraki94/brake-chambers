  ...
  return (
    <header className="sticky top-0 z-50 w-full flex flex-col shadow-sm">
      ...
      <div className="hidden md:flex bg-navy-900 text-white border-b border-navy-800 text-xs font-medium">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl h-9 flex items-center justify-between">
      ...
      <div className="bg-[#FFB000] border-b border-[#e59d00]">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="h-14 md:h-16 flex items-center justify-between gap-4 md:gap-8">
            ...
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 font-heading font-bold text-xl md:text-2xl tracking-tight text-navy-900 flex-shrink-0">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-navy-900 rounded-xl flex items-center justify-center">
                <span className="text-white font-bold text-lg md:text-xl">BRC</span>
              </div>
        ...
        >
          <div className="px-4 pt-4 pb-2" ref={mobileSearchContainerRef}>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href={`/capabilities`} onClick={() => setIsMobileMenuOpen(false)} className={`p-3 font-semibold rounded-xl transition-colors text-navy-900 hover:bg-slate-50 hover:text-slate-700`}>Capabilities</Link>
              <Link href={`/technical-resources`} onClick={() => setIsMobileMenuOpen(false)} className={`p-3 font-semibold rounded-xl transition-colors text-navy-900 hover:bg-slate-50 hover:text-slate-700`}>Technical Resources</Link>
              <Link href={`/company`} onClick={() => setIsMobileMenuOpen(false)} className={`p-3 font-semibold rounded-xl transition-colors text-navy-900 hover:bg-slate-50 hover:text-slate-700`}>Company</Link>
      ...
      <div className={`hidden md:block relative z-40 transition-colors duration-300 ${isScrolled ? 'bg-navy-900 border-t border-navy-800 border-b-2 border-[#FFB000] shadow-md' : 'bg-slate-50 border-y border-navy-100 shadow-sm'}`}>
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <nav className={`flex items-center gap-6 lg:gap-8 h-12 text-sm font-semibold transition-colors duration-300 ${isScrolled ? 'text-navy-100' : 'text-navy-700'}`}>
            ...
            {/* Capabilities Dropdown (NEW) */}
            <div className="group h-full flex items-center">
              <Link href="/capabilities" className={`cursor-pointer transition-colors py-3 h-full flex items-center border-b-[3px] border-transparent ${isScrolled ? 'group-hover:border-amber-400 group-hover:text-white' : 'group-hover:border-amber-500 group-hover:text-amber-600'}`}>
                Capabilities
              </Link>
              <div className="absolute top-full left-0 w-full bg-white shadow-2xl border-t border-slate-200 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
                <div className="container mx-auto px-4 lg:px-8 max-w-7xl py-8">
                  <div className="grid grid-cols-4 gap-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        <li><Link href="/capabilities/production-process" className={getLinkClass('/capabilities/production-process')}>Production Process</Link></li>
                        <li><Link href="/capabilities/facility-overview" className={getLinkClass('/capabilities/facility-overview')}>Facility Overview</Link></li>
                        <li><Link href="/capabilities/materials" className={getLinkClass('/capabilities/materials')}>Material Sourcing</Link></li>
                      </ul>
                    </div>
                    {/* Column 2 */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><ShieldCheck className="w-5 h-5 text-amber-500" /> Quality Assurance</h3>
                      <ul className="space-y-3">
                        <li><Link href="/capabilities/iso-certifications" className={getLinkClass('/capabilities/iso-certifications')}>ISO Certifications</Link></li>
                        <li><Link href="/capabilities/testing-laboratory" className={getLinkClass('/capabilities/testing-laboratory')}>Testing Laboratory</Link></li>
                        <li><Link href="/capabilities/regulatory-compliance" className={getLinkClass('/capabilities/regulatory-compliance')}>Regulatory Compliance</Link></li>
                      </ul>
                    </div>
                    {/* Column 3 */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><FlaskConical className="w-5 h-5 text-amber-500" /> R&D and Engineering</h3>
                      <ul className="space-y-3">
                        <li><Link href="/capabilities/custom-engineering" className={getLinkClass('/capabilities/custom-engineering')}>Custom Engineering</Link></li>
                        <li><Link href="/capabilities/rapid-prototyping" className={getLinkClass('/capabilities/rapid-prototyping')}>Rapid Prototyping</Link></li>
                        <li><Link href="/capabilities/recent-innovations" className={getLinkClass('/capabilities/recent-innovations')}>Recent Innovations</Link></li>
                      </ul>
                    </div>
                    {/* Column 4 - Featured Image/Link */}
                    <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 flex flex-col justify-center">
                      <h4 className="font-bold text-navy-900 mb-2">Build With Us</h4>
                      <p className="text-sm text-slate-500 mb-4">Partner directly with the manufacturer for your OEM or large fleet needs.</p>
                      <Link href="/contact" className="inline-block text-center bg-navy-900 text-white font-bold py-2 px-4 rounded-lg hover:bg-navy-800 transition-colors text-sm">
            ...
            {/* Technical Resources */}
            <div className="group h-full flex items-center">
              <Link href={`/technical-resources`} className={`transition-colors py-3 h-full flex items-center border-b-[3px] border-transparent ${isScrolled ? 'group-hover:border-amber-400 group-hover:text-white' : 'group-hover:border-amber-500 group-hover:text-amber-600'}`}>
                Technical Resources
              </Link>
              <div className="absolute top-full left-0 w-full bg-white shadow-2xl border-t border-slate-200 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
                <div className="container mx-auto px-4 lg:px-8 max-w-7xl py-8">
                  <div className="grid grid-cols-4 gap-8">
                    {/* Column 1: Installation & Maintenance */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><Wrench className="w-5 h-5 text-amber-500" /> Installation & Maint.</h3>
                      <ul className="space-y-3">
                        <li><Link href="/technical-resources/installation" className={getLinkClass('/technical-resources/installation')}>Installation Guides</Link></li>
                        <li><Link href="/technical-resources/maintenance" className={getLinkClass('/technical-resources/maintenance')}>Maintenance Schedules</Link></li>
                        <li><Link href="/technical-resources/troubleshooting" className={getLinkClass('/technical-resources/troubleshooting')}>Troubleshooting Guides</Link></li>
                        <li><Link href="/technical-resources/caging" className={getLinkClass('/technical-resources/caging')}>Safe Caging Procedures</Link></li>
                      </ul>
                    </div>

                    {/* Column 2: Specs & Sizing */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><Ruler className="w-5 h-5 text-amber-500" /> Specifications & Sizing</h3>
                      <ul className="space-y-3">
                        <li><Link href="/technical-resources/size-charts" className={getLinkClass('/technical-resources/size-charts')}>Size & Dimension Charts</Link></li>
                        <li><Link href="/technical-resources/stroke-length" className={getLinkClass('/technical-resources/stroke-length')}>Stroke Length Guide</Link></li>
                        <li><Link href="/technical-resources/pushrod" className={getLinkClass('/technical-resources/pushrod')}>Pushrod Calculations</Link></li>
                        <li><Link href="/technical-resources/port-threads" className={getLinkClass('/technical-resources/port-threads')}>Air Port Thread Sizes</Link></li>
                      </ul>
                    </div>

                    {/* Column 3: Safety & Compliance */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><ShieldAlert className="w-5 h-5 text-amber-500" /> Safety & Compliance</h3>
                      <ul className="space-y-3">
                        <li><Link href="/technical-resources/cvsa" className={getLinkClass('/technical-resources/cvsa')}>CVSA Out-of-Service Criteria</Link></li>
                        <li><Link href="/technical-resources/fmvss-121" className={getLinkClass('/technical-resources/fmvss-121')}>FMVSS 121 Standards</Link></li>
                        <li><Link href="/technical-resources/spring-brake-safety" className={getLinkClass('/technical-resources/spring-brake-safety')}>Spring Brake Safety Warnings</Link></li>
                        <li><Link href="/technical-resources/warranty" className={getLinkClass('/technical-resources/warranty')}>Warranty Information</Link></li>
                      </ul>
                    </div>

                    {/* Column 4: Engineering & Training */}
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><BookOpen className="w-5 h-5 text-amber-500" /> Engineering & Training</h3>
                      <ul className="space-y-3">
                        <li><Link href="/technical-resources/cad-models" className={getLinkClass('/technical-resources/cad-models')}>CAD Models & 3D Files</Link></li>
                        <li><Link href="/technical-resources/material-specs" className={getLinkClass('/technical-resources/material-specs')}>Material Specifications</Link></li>
                        <li><Link href="/technical-resources/video-tutorials" className={getLinkClass('/technical-resources/video-tutorials')}>Video Training Library</Link></li>
                        <li className="pt-2"><Link href="/technical-resources/whitepapers" className="inline-flex items-center gap-2 transform transition-transform duration-200 text-amber-600 font-bold hover:text-amber-500 hover:translate-x-1 text-sm"><FileText className="w-4 h-4" /> Engineering Whitepapers</Link></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            {/* Flexible space to push Company/Contact to the right */}
            ...
            <div className="group h-full flex items-center">
              ...
              <div className="absolute top-full right-0 w-[600px] bg-white shadow-2xl border-t border-slate-200 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
                <div className="p-8">
                  <div className="grid grid-cols-2 gap-8">
                    <div>
                      ...
                      <ul className="space-y-3">
                        <li><Link href="/about" className={getLinkClass('/about')}>Our Story</Link></li>
                        <li><Link href="/company/leadership" className={getLinkClass('/company/leadership')}>Leadership Team</Link></li>
                        <li><Link href="/company/careers" className={getLinkClass('/company/careers')}>Careers</Link></li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="flex items-center gap-2 text-navy-900 font-bold text-lg mb-4 border-b border-slate-200 pb-2"><FileSignature className="w-5 h-5 text-amber-500" /> Insights & News</h3>
                      <ul className="space-y-3">
                        <li><Link href="/blog" className={getLinkClass('/blog')}>Industry Blog</Link></li>
                        <li><Link href="/company/news" className={getLinkClass('/company/news')}>Press & News</Link></li>
                        <li><Link href="/company/events" className={getLinkClass('/company/events')}>Trade Shows & Events</Link></li>
                      </ul>
                    </div>
                  </div>
                </div>
