  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 py-8 max-w-7xl">
      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-navy-900/5 border border-navy-50 overflow-hidden flex flex-col lg:flex-row mt-6 relative">
        ...
        {/* Left: Image Gallery */}
        <div className="w-full lg:w-1/2 p-5 lg:p-12 bg-gradient-to-b from-[#F8FAFC] to-white flex flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-navy-50">
        ...
        <div className="w-full lg:w-1/2 p-5 lg:p-12 flex flex-col relative z-10">
      ...
      <section className="mt-10 pt-10 border-t border-slate-100 mb-16">
