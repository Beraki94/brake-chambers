      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link href={`/`} className="flex items-center gap-2 font-heading font-bold text-2xl tracking-tight text-white mb-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href={`/about`} className="text-navy-300 hover:text-slate-400 text-sm transition-colors">About BRC</Link></li>
              <li><Link href={`/quality-assurance`} className="text-navy-300 hover:text-slate-400 text-sm transition-colors">Quality Assurance</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-navy-300 text-sm">WhatsApp: +86 138 0000 0000</span>
              </li>
              <li className="flex items-start gap-3">
