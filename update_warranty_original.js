          ...
          >
            <div className="flex flex-col md:flex-row gap-10 items-center">
              ...
              <motion.div variants={fadeInUp} className="md:w-2/3">
                ...
                <div className="mb-6">
                  <h4 className="font-bold text-navy-900 mb-3 flex items-center gap-2"><CheckCircle className="w-5 h-5 text-emerald-500" /> Covered (Subject to Conditions)</h4>
                ...
                <div>
                  <h4 className="font-bold text-navy-900 mb-3 flex items-center gap-2"><AlertTriangle className="w-5 h-5 text-amber-500" /> Conditions</h4>
